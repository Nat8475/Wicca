...
const clientID = '9ff14a3b39b64149b5a99a6e885f6d0c'
const clientSecret = 'e7a85bccc538487e9bfc7e4249733ac3'
...
const nodes = [
  {
    identifier: "Node 1",
    host: "botlavalink.herokuapp.com",
...
client.music = new Manager({
  ...
  .on("queueEnd", async (player) => {
    ...
    client.channels.cache
      ...
      .send(`📃 | A fila de Música acabou e eu me desconectei do canal de voz.`);
