  ...
  async run(message) {
    ...
    try {
      ...
      if (xp >= nextLevel) {
        ...
        message.react("<:uparrow:859597138991906816>");
      }
      ...
      if (comando) {
        ...
        const hook = new WebhookClient({id: `844034198792175646`, token: `5ltRKYvh2uJeCqKYZxMxQ8IV0eKsrUudCtTkzywdsnAyFerqYxfdaIKIbYWcK26afGIF`});
        ...
        hook.send({ embed: [EMBED_COMMANDS]})

        // ========================== //

        if (!["624399506011717632"].includes(message.author.id)) {
